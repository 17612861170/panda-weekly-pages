(function () {
  ...
  var DATA_VERSION = '20260824-wuhanhuiju-renew-v6';
  var priorSupport = {};
  ...
  function updateDates() {
    document.querySelectorAll('.four-week-table thead tr').forEach(function (row) {
      ...
      heads[5].innerHTML = '本周<br><small>8/17-8/23</small>';
    });
    document.querySelectorAll('[data-custom-start]').forEach(function (input) { input.value = '2026-08-17'; });
    document.querySelectorAll('[data-custom-end]').forEach(function (input) { input.value = '2026-08-23'; });
  }
